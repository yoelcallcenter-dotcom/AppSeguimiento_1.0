...
import { UserCircle2, CalendarDays, Target, KeyRound, Lightbulb, Sun, ArrowRight, Clock, CalendarClock, Sparkles, MessagesSquare, Trophy } from "lucide-react";
      ...
      <div className="space-y-4">
        {activeSection === "hoy" && (
          settings.showDaySummary !== false ? (
            ...
            >
              El resumen de jornada está desactivado (Configuración &gt; Avanzado &gt; Productividad).
            </div>
          )
        )}
